<template>
    <div>
        <div :class="$style.container" style="">
            ...
            <svg v-if="edit === false" xmlns="http://www.w3.org/2000/svg" :class="$style.edit__icon" style="" width="12px" height="12px" viewBox="0 0 24 24" fill="none" @click="editButton()">
        ...
        <svg @click="save()" v-if="edit === true" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 507.506 507.506" style="cursor: pointer; enable-background:new 0 0 507.506 507.506;" xml:space="preserve" width="12px" height="12px">
           <g>
	          <path d="M163.865,436.934c-14.406,0.006-28.222-5.72-38.4-15.915L9.369,304.966c-12.492-12.496-12.492-32.752,0-45.248l0,0   c12.496-12.492,32.752-12.492,45.248,0l109.248,109.248L452.889,79.942c12.496-12.492,32.752-12.492,45.248,0l0,0   c12.492,12.496,12.492,32.752,0,45.248L202.265,421.019C192.087,431.214,178.271,436.94,163.865,436.934z"/>
           </g>
        </svg>
        <svg v-if="edit === true" @click="cancel()" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.021 512.021" style="cursor: pointer; margin-left:10px; enable-background:new 0 0 512.021 512.021;" xml:space="preserve" width="12px" height="12px">
            <g>
...
import {InlineEdit, InlineOptionEdit} from "./Types/InlineEdit";
